...
final class StaticTable {
  ...
  private static final List<HeaderField> STATIC_TABLE = Arrays.asList(
    /*  1 */ new HeaderField(":authority", EMPTY, ":authority"),
    /*  2 */ new HeaderField(":method", "GET", "GET"),
    /*  3 */ new HeaderField(":method", "POST", "POST"),
    /*  4 */ new HeaderField(":path", "/", "/"),
    /*  5 */ new HeaderField(":path", "/index.html", "/index.html"),
    /*  6 */ new HeaderField(":scheme", "http", "http"),
    /*  7 */ new HeaderField(":scheme", "https", "https"),
    /*  8 */ new HeaderField(":status", "200", 200),
    /*  9 */ new HeaderField(":status", "204", 204),
    /* 10 */ new HeaderField(":status", "206", 206),
    /* 11 */ new HeaderField(":status", "304", 304),
    /* 12 */ new HeaderField(":status", "400", 400),
    /* 13 */ new HeaderField(":status", "404", 404),
    /* 14 */ new HeaderField(":status", "500", 500),
    /* 15 */ new HeaderField("accept-charset", EMPTY, "accept-charset"),
    /* 16 */ new HeaderField("accept-encoding", "gzip, deflate", new String[]{"gzip", "deflate"}),
