...
final class StaticTable {
  ...
  private static final List<HeaderField> STATIC_TABLE = Arrays.asList(
    ...
    /*  8 */ HeaderField.forNameValue(":status", "200"),
    /*  9 */ HeaderField.forNameValue(":status", "204"),
    /* 10 */ HeaderField.forNameValue(":status", "206"),
    /* 11 */ HeaderField.forNameValue(":status", "304"),
    /* 12 */ HeaderField.forNameValue(":status", "400"),
    /* 13 */ HeaderField.forNameValue(":status", "404"),
    /* 14 */ HeaderField.forNameValue(":status", "500"),
    /* 15 */ HeaderField.forNameOnly("accept-charset"),
    /* 16 */ HeaderField.forNameValue("accept-encoding", "gzip, deflate"),
